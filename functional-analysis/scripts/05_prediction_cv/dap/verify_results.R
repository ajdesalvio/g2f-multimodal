...
load_expected_jobs <- function(jobs_dir) {
  split_files <- c(
    file.path(jobs_dir, "DAP_CV_Prediction_Jobs_CV_2_1.txt"),
    file.path(jobs_dir, "DAP_CV_Prediction_Jobs_CV_0_00.txt")
  )
  ...
  combined_file <- file.path(jobs_dir, "DAP_CV_Prediction_Jobs.txt")
...
run_prediction_results_audit <- function(
  ...
  restart_files <- c(
    CV_2_1 = file.path(jobs_dir, paste0("DAP_CV_Prediction_Jobs_CV_2_1_", variant, "_Missing_Only.txt")),
    CV_0_00 = file.path(jobs_dir, paste0("DAP_CV_Prediction_Jobs_CV_0_00_", variant, "_Missing_Only.txt"))
  )
